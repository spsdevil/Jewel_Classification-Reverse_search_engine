...
def visualize_boxes_and_labels_on_image_array(current_frame_number,
  ...
  for box, color in box_to_color_map.items():
    ...
    if(mode == 1 and targeted_objects == None):
      # present_class.add(display_str_list[0].split(":")[0], display_str_list[0].split(":")[1])
      present_class[display_str_list[0].split(":")[0]] = [int(display_str_list[0].split(":")[1][:-1]), box]
  ...
  if(mode == 1):
    return counter, csv_line_util, present_class
